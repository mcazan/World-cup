...
echo "$($PSQL "SELECT name FROM games AS g FULL JOIN teams AS t ON g.winner_id=t.team_id OR g.opponent_id=t.team_id WHERE (year=2014 AND round='Eighth-Final') ORDER BY name ASC")"
